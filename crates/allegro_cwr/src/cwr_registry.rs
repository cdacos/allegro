...
impl CwrRegistry {
    ...
    pub fn to_cwr_line_without_newline(&self, cwr_version: &crate::domain_types::CwrVersion) -> String {
        match self {
            CwrRegistry::Hdr(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Grh(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Grt(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Trl(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Agr(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Nwr(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Ack(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Ter(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Ipa(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Npa(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Spu(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Npn(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Spt(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Swr(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Nwn(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Swt(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Pwr(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Alt(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Nat(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Ewt(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Ver(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Per(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Npr(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Rec(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Orn(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Ins(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Ind(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Com(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Msg(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Net(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Now(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Ari(record) => record.to_cwr_line_without_newline(cwr_version),
            CwrRegistry::Xrf(record) => record.to_cwr_line_without_newline(cwr_version),
        }
    }
}
