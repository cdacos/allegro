...
impl XrfRecord {
    ...
    pub fn to_cwr_line(&self) -> String {
        vec![
            ...
            format!("{:3}", self.organisation_code),
            format!("{:14}", self.identifier),
            format!("{:1}", self.identifier_type),
            format!("{:1}", self.validity)
        ].join("")
    }
}
...
mod tests {
    ...
    fn test_xrf_creation() {
        let xrf = XrfRecord::new(
            "00000001".to_string(),
            "00000001".to_string(),
            "ISW".to_string(),
            "T1234567890123".to_string(),
            "W".to_string(),
            "Y".to_string(),
        );
