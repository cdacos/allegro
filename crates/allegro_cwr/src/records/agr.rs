...
pub struct AgrRecord {
    ...
    #[cwr(title = "International standard agreement code (14 chars, optional)", start = 33, len = 14)]
    ...
    #[cwr(title = "Agreement end date YYYYMMDD (8 chars, optional)", start = 57, len = 8)]
    pub agreement_end_date: Option<Date>,

    #[cwr(title = "Retention end date YYYYMMDD (8 chars, optional)", start = 65, len = 8)]
    pub retention_end_date: Option<Date>,

    #[cwr(title = "Prior royalty status (1 char)", start = 73, len = 1)]
    pub prior_royalty_status: YesNo,

    #[cwr(title = "Prior royalty start date YYYYMMDD (8 chars, conditional)", start = 74, len = 8)]
    ...
    #[cwr(title = "Post-term collection end date YYYYMMDD (8 chars, conditional)", start = 83, len = 8)]
    pub post_term_collection_end_date: Option<Date>,

    #[cwr(title = "Date of signature of agreement YYYYMMDD (8 chars, optional)", start = 91, len = 8)]
    ...
    #[cwr(title = "Society assigned agreement number (14 chars, optional, v2.1+)", start = 107, len = 14)]
