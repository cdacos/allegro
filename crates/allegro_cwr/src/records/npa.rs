...
impl NpaRecord {
    ...
    pub fn to_cwr_line(&self) -> String {
        let mut fields = vec![
            ...
            format!("{:160}", self.interested_party_name),
            format!("{:160}", self.interested_party_writer_first_name)
        ];
