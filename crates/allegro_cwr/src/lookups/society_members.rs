...
pub static SOCIETY_TRANSMITTER_CODES: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    ...
    m.insert("107", "ACAM");
    m.insert("168", "ACCESS");
    m.insert("ACC-1", "Accorder Music Publishing America");
    ...
    m.insert("AE-2", "AETN UK MUSIC PUBLISHING");
    ...
    m.insert("APO-1", "Aporai Records Inc");
    ...
    m.insert("141", "ATN");
    m.insert("174", "ATN");
    m.insert("AUN-2", "Audio Network (Holland) B.V.");
    m.insert("AUN-3", "Audio Network Gmbh");
